            ...
            @for ($i = 10; $i < 23; $i++)
                <tr>
                    ...
                    @for ($j = 0; $j <= 4; $j++)
                        ...
                        @elseif ($reserva->user_id == auth()->id())
                            <td>
                                <button
                        ...
                        @else
                            <td>
                                <button
                                    class="focus:outline-none text-white bg-grey-700 hover:bg-gray-800 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Reservado
                                </button>
                            </td>
                        @endif
                    @endfor
